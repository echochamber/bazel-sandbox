...
prost_proto = rule(
    ...
    attrs = dict(
        ...
        _plugins = attr.label_list(
            ...
            default = [
                Label("//bzl-sandbox/rust/proto/toolchains:prost_proto_plugin"),
            ],
...
prost_tonic = rule(
    ...
    attrs = dict(
        ...
        _plugins = attr.label_list(
            providers = [ProtoPluginInfo],
            default = [
                Label("//bzl-sandbox/rust/proto/toolchains:prost_tonic_plugin"),
            ],
...
prost_crate = rule(
    ...
    attrs = dict(
        ...
        _plugins = attr.label_list(
            providers = [ProtoPluginInfo],
            default = [
                Label("//bzl-sandbox/rust/proto/toolchains:prost_crate_plugin"),
            ],
