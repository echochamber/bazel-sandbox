...
load("//ts/angular/tools:ng.bzl", "ng_esbuild", "ng_project")
load("//ts/angular/tools:ts.bzl", "ts_project")
load("//ts/angular/tools:sass.bzl", "sass")
load("//ts/angular/tools:karma.bzl", "generate_karma_config", "generate_test_bootstrap", "generate_test_setup")
