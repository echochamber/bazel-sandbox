...
import (
	...
	gw "gateway/gen/github.com/echochamber/rdprotos/gen/go/your/service/v1"
)
...
func SetupMux(ctx context.Context, cfg proxyConfig) *http.ServeMux {
	...
	err := gw.RegisterGreeterHandlerFromEndpoint(ctx, gwmux, cfg.backend, opts)
	if err != nil {
...
func SetupViper() *viper.Viper {
	...
	v := viper.GetViper()
	bindEnvVars(v, strings.NewReplacer(EnvVarSepChar, ViperKeySepChar), strings.ToUpper("Greeter"), ResponseHeaders)
	return v
}
