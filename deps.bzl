"""Run //:gazelle-update-repos to update this file."""
...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:t6rV4iP1cs/sJH5SYvcLanOshLvmtvwSC+Mt+GfG05s=",
        version = "v1.10.0",
    )
    go_repository(
        name = "com_github_bufbuild_connect_go",
        importpath = "github.com/bufbuild/connect-go",
        sum = "h1:AUgqqO2ePdOJSpPOep6BPYz5v2moW1Lb8sQh0EeRzQ8=",
        version = "v1.1.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:F1LLQqQ8WoIbyoxLUY+JUZe1kuHdxThM6CPUATzE6Io=",
        version = "v0.0.0-20221102093814-76f304f74e5e",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:MBbQK392K3u8NTLbKOCIi3XdI+y+c6yt5oMq0X3xviw=",
        version = "v1.14.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:d9krS/lG3dn6N7y+R8o9PTgIixlYAaDk35f3/B4jZOw=",
        version = "v0.10.5",
    )
    go_repository(
