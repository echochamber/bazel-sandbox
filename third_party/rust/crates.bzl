...
def raze_fetch_remote_crates():
    ...
    maybe(
        http_archive,
        name = "raze__bumpalo__3_12_2",
        url = "https://crates.io/api/v1/crates/bumpalo/3.12.2/download",
        type = "tar.gz",
        sha256 = "3c6ed94e98ecff0c12dd1b04c15ec0d7d9458ca8fe806cea6f12954efe74c63b",
        strip_prefix = "bumpalo-3.12.2",
        build_file = Label("//third_party/rust/remote:BUILD.bumpalo-3.12.2.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "raze__clap__4_2_7",
        url = "https://crates.io/api/v1/crates/clap/4.2.7/download",
        type = "tar.gz",
        sha256 = "34d21f9bf1b425d2968943631ec91202fe5e837264063503708b83013f8fc938",
        strip_prefix = "clap-4.2.7",
        build_file = Label("//third_party/rust/remote:BUILD.clap-4.2.7.bazel"),
    )

    maybe(
        http_archive,
        name = "raze__clap_builder__4_2_7",
        url = "https://crates.io/api/v1/crates/clap_builder/4.2.7/download",
        type = "tar.gz",
        sha256 = "914c8c79fb560f238ef6429439a30023c862f7a28e688c58f7203f12b29970bd",
        strip_prefix = "clap_builder-4.2.7",
        build_file = Label("//third_party/rust/remote:BUILD.clap_builder-4.2.7.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "raze__proc_macro2__1_0_58",
        url = "https://crates.io/api/v1/crates/proc-macro2/1.0.58/download",
        type = "tar.gz",
        sha256 = "fa1fb82fc0c281dd9671101b66b771ebbe1eaf967b96ac8740dcba4b70005ca8",
        strip_prefix = "proc-macro2-1.0.58",
        build_file = Label("//third_party/rust/remote:BUILD.proc-macro2-1.0.58.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/remote:BUILD.quote-1.0.27.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/remote:BUILD.regex-1.8.1.bazel"),
    )

    maybe(
        http_archive,
        name = "raze__regex_syntax__0_7_1",
        ...
        build_file = Label("//third_party/rust/remote:BUILD.regex-syntax-0.7.1.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "raze__syn__2_0_16",
        url = "https://crates.io/api/v1/crates/syn/2.0.16/download",
        type = "tar.gz",
        sha256 = "a6f671d4b5ffdb8eadec19c0ae67fe2639df8684bd7bc4b83d986b8db549cf01",
        strip_prefix = "syn-2.0.16",
        build_file = Label("//third_party/rust/remote:BUILD.syn-2.0.16.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/remote:BUILD.tokio-1.28.1.bazel"),
    )
